...
public class InterfaceGrapheOrienteNonValue extends JFrame {
	 ...
	 * Create the frame.
	 */
	public InterfaceGrapheOrienteNonValue() {
		...
		btnImporterFsapsd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//graphe = GrapheOriente.GrapheFromFichier();
			}
		});
		...
		btnAfficherGraphe.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(graphe!=null)
				{
					//GrapheOriente.afficherGrapheFromMatrice(null, Val, null);
